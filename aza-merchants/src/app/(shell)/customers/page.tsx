  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-foreground/40 text-sm mt-0.5">Customers who have paid you at least once</p>
      </div>
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-48 gap-3">
            ...
            <p className="text-foreground/40 text-sm">No customers yet</p>
          </div>
        ) : (
          <>
                ...
                <tbody className="divide-y divide-white/[0.04]">
                  {page.content.map((c) => (
                    <tr key={c.id} className="hover:bg-muted/10 transition-colors">
                      ...
                      <td className="px-5 py-3.5 text-right text-sm font-medium text-foreground">{fmt(c.totalSpend)}</td>
