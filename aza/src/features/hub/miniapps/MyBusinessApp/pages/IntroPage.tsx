...
const slides = [
  {
    title: "BUSINESS ON AZA",
    description: "Accept payments from millions of Aza users.",
    isLight: false,
  },
  {
    title: "ACCEPT PAYMENTS",
    description: "Instant GHS payments from Aza users.",
    isLight: false,
  },
  {
    title: "PAYMENT LINKS",
    description: "Share links that open a hosted checkout.",
    isLight: false,
  },
  {
    title: "DEVELOPER API",
    description: "Build integrations with your own API keys.",
    isLight: false,
  },
  {
    title: "INSTANT PAYOUTS",
    description: "Withdraw your balance to your Aza wallet.",
    isLight: false,
  },
];

export default function IntroPage({ Colors }: NavProps) {
  ...
  useEffect(() => {
    ...
    Animated.timing(fadeAnim, {
      toValue: slides[activeSlide]?.isLight ? 1 : 0,
      duration: 600,
      useNativeDriver: false,
    }).start();
      ...
      >
        ...
        >
          ...
          <Text style={styles.bottomSheetDescription}>
            By continuing, you agree to our Merchant Terms & Privacy Policy.
          </Text>
          ...
          <Button
            ...
            onPress={() => {
              ...
              navigation.navigate('MerchantBusinessName');
            }}
            backgroundColor="#1E5128"
            textColor="#B7ED7E"
            borderRadius={24}
