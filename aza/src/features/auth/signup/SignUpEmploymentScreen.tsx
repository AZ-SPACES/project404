...
type EmploymentOption = 'Student' | 'Part-Time' | 'Full-Time' | 'Self-employed' | 'Retired' | 'Unemployed';
...
export default function SignUpEmploymentScreen() {
    ...
    const [selectedEmployment, setSelectedEmployment] = useState<EmploymentOption | null>(null);
