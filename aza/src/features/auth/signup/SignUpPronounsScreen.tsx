...
export default function SignUpPronounsScreen() {
    ...
    const renderOption = (label: string, id: PronounOption) => (
        <TouchableOpacity 
            style={[styles.radioItem, selectedPronoun === id && styles.radioItemSelected]} 
            onPress={() => setSelectedPronoun(id)}
            activeOpacity={0.7}
        >
            <View style={[styles.radioCircle, selectedPronoun === id && styles.radioCircleSelected]} />
            <Text style={[styles.radioLabel, selectedPronoun === id && styles.radioLabelSelected]}>
                {label}
            </Text>
        </TouchableOpacity>
    );
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
                ...
                >
                    ...
                    >
                        ...
                        <View style={[styles.inputContainer, selectedPronoun === 'custom' && styles.inputContainerActive]}>
                            <TextInput
                                style={styles.input}
