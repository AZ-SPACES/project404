      ...
      >
        ...
        <View style={styles.section}>
          ...
          <SettingRow 
            ...
            title="App security" 
            subtitle="Require Face ID for login, after 5 minutes of inactivity"
            onPress={() => {}}
          />
        ...
        <View style={styles.section}>
          ...
          <SettingRow 
            ...
            iconName="search" 
            title="Find me by" 
            subtitle="Choose how people on Wise can find your account"
            onPress={() => {}}
          />
          ...
          <SettingRow 
            ...
            subtitle="Send and request from your contacts who have a Wise account"
            showSwitch
          ...
          <SettingRow 
            ...
            subtitle="Allow Wise to store and use your selfie and ID for automated verification"
            showSwitch
