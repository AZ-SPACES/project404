...
public class StatementService {
    ...
    private static class PageEvent extends PdfPageEventHelper {
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            ...
            ColumnText.showTextAligned(cb, Element.ALIGN_LEFT,
                    new Phrase("AZA Financial Technology Ltd  •  Licensed by the Bank of Ghana under the Payment Systems and Services Act, 2019 (Act 987)  •  support@aza.systems",
    ...
    public byte[] generateStatementPdf(User user, LocalDateTime start, LocalDateTime end) {
        ...
        String verifyUrl  = "https://aza.systems/verify/statement?code=" + verifyCode;
        ...
        try {
            ...
            Paragraph disc = new Paragraph(
                    ...
                    "Bank of Ghana under the Payment Systems and Services Act, 2019 (Act 987). For queries contact support@aza.systems.",
