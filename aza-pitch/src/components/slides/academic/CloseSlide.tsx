  ...
  return (
    <Slide id="close">
      ...
      <h2 id="close-title" className="display mt-7 anim" style={stagger(1)}>
        An invariant that is understood by its authors is not the same as an invariant that is{" "}
        <span className="accent">enforced</span>.
      </h2>

      <p className="lede mt-6 anim" style={stagger(2)}>
        The gap between the two is exactly what a mechanical gate closes, and it is invisible
        without one. That is the argument this system was built to make, and the evidence for it
        is a table with two red cells in it — not the one with nine green.
      </p>

      <hr className="rule mt-12 anim anim-fade" style={stagger(3)} />
      ...
      <p className="body-sm mt-14 anim" style={stagger(8)}>
        Thank you. Questions welcome — including the licensing one.
      </p>
    </Slide>
  );
}
